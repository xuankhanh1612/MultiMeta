...
b.push(g.TypeExt.Byte(m.receivers))),void 0!=m.cache&&m.cache!==d.Constants.EventCaching.DoNotCache&&(b.push(d.Constants.ParameterCode.Cache),b.push(g.TypeExt.Byte(m.cache))),void 0!=m.interestGroup&&(this.checkGroupNumber(m.interestGroup)?(b.push(d.Constants.ParameterCode.Group),b.push(g.TypeExt.Byte(m.interestGroup))):this._logger.exception(502,"raiseEvent - Group not a number: "+m.interestGroup)),void 0!=m.targetActors&&(b.push(d.Constants.ParameterCode.ActorList),b.push(m.targetActors)),m.webForward&&
...
(function(g){g.IsEmscriptenBuild=g.IsEmscriptenBuildInternal;g.Version="4.1.1.4"+(g.IsEmscriptenBuild?".em":"")})(Photon||(Photon={}));
